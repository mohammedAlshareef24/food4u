                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="row" style="width: 12%">{{ $key=$key+1 }}</th>
                                <td hidden >{{ $row->id+1}}</td>
                            <td>{{ $row->cat_name }}</td>

                            <td style="width: 15%"><button class="btn btn-primary editbtn">edit</button></td>

                            <td style="width: 15%">
                                 <a href="{{ route('cat.delete',$row->id) }}" class="btn btn-danger" id="delete">delete</a>
                             </td>
